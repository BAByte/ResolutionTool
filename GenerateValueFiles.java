...
public class GenerateValueFiles {
	...
	private final static String VALUE_TEMPLATE = "values-{1}x{0}";

    private String valeuName = VALUE_TEMPLATE;
	...
	public static void main(String[] args) {
		...
		GenerateValueFiles gf= new GenerateValueFiles(baseW, baseH, addition);
        // gf.generate();
        gf.generateLand();
	}
